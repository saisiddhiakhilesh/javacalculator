...
public class Fraction {
	...
	/** The  method below is to adds two fractions and returns the sum of the two fractions */
	public Fraction add(Fraction second)
 {
	...
	/** This method below  subtracts two fractions and returns the difference */
